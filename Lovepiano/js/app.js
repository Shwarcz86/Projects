 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-menu")) {
                    ...
                    document.querySelector("._catalog-active") ? document.querySelector("._catalog-active").classList.remove("_catalog-active") : null;
        ...
        InputMask.prototype.mask = function(e) {
            var _this = e.target, matrix = this.layout, i = 0, def = matrix.replace(/\D/g, ""), val = _this.value.replace(/\D/g, "");
            ...
            } else this.setCursorPosition(_this.value.length, _this);
        };
        ...
        InputMask.prototype.getElement = function(selector) {
            if (void 0 === selector) return false;
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItem => {
                ...
                inputs.forEach(((el, index) => {
                    el.addEventListener("change", (e => {
                        setItem(index, e.currentTarget.value);
                    }));
                }));
            }));
        }
        ...
        function initSliders() {
            ...
            if (window.matchMedia("(max-width: 576px)").matches) if (document.querySelector(".work__slider")) new core(".work__slider", {
            ...
            if (window.matchMedia("(max-width: 576px)").matches) if (document.querySelector(".main-services__slider")) new core(".main-services__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
                ...
                speed: 800,
                pagination: {
                    el: ".main-services__slider-control",
                    clickable: true
                },
                navigation: {
                    prevEl: ".main-services__slider-button-prev",
                    nextEl: ".main-services__slider-button-next "
                },
                on: {}
            });
            ...
            if (document.querySelector(".information__slider")) new core(".information__slider", {
                ...
                navigation: {
                    prevEl: ".information__slider-button-prev",
                    nextEl: ".information__slider-button-next"
                },
                pagination: {
                    el: ".information__slider-control",
                    clickable: true
                },
                on: {}
            });
            ...
            if (document.querySelector(".requirements__slider")) new core(".requirements__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
                ...
                autoHeight: true,
                pagination: {
                    el: ".requirements__control",
                    clickable: true
                },
                navigation: {
                    prevEl: ".requirements__slider-button-prev",
                    nextEl: ".requirements__slider-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".tabs-card-body__thumbs")) {
                var thumbsSwiper = new core(".tabs-card-body__thumbs", {
                    modules: [ Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 4,
                ...
                if (document.querySelector(".tabs-card-body__slider")) new core(".tabs-card-body__slider", {
                    ...
                    autoHeight: true,
                    pagination: {
                        el: ".thumbs-card__control",
                        clickable: true
                    },
                    navigation: {
                        prevEl: ".thumbs-card__button-prev",
                        nextEl: ".thumbs-card__button-next"
                    },
                    thumbs: {
                        swiper: thumbsSwiper
                    },
        ...
        (function(root, factory) {
            if ("function" === typeof define && define.amd) define([], factory); else if ("object" === typeof module && module.exports) module.exports = factory(); else root.Rellax = factory();
            ...
            var Rellax = function(el, options) {
                ...
                var transformProp = window.transformProp || function() {
                    ...
                    if (null === testEl.style.transform) {
                        ...
                        for (var vendor in vendors) if (void 0 !== testEl.style[vendors[vendor] + "Transform"]) return vendors[vendor] + "Transform";
                    }
                    return "transform";
                }();
                self.options = {
                ...
                function validateCustomBreakpoints() {
                    if (3 === self.options.breakpoints.length && Array.isArray(self.options.breakpoints)) {
                        ...
                        self.options.breakpoints.forEach((function(i) {
                            if ("number" !== typeof i) isNumerical = false;
                            if (null !== lastVal) if (i < lastVal) isAscending = false;
                            lastVal = i;
                        }));
                ...
                if (elements.length > 0) self.elems = elements; else {
                    console.warn("Rellax: The elements you're trying to select don't exist.");
                    return;
                }
                if (self.options.wrapper) if (!self.options.wrapper.nodeType) {
                    var wrapper = document.querySelector(self.options.wrapper);
                    if (wrapper) self.options.wrapper = wrapper; else {
                ...
                var createBlock = function(el) {
                    ...
                    if (!dataXsSpeed && !dataMobileSpeed && !dataTabletSpeed && !dataDesktopSpeed) breakpoints = false; else mapBreakpoints = {
                        xs: dataXsSpeed,
                        sm: dataMobileSpeed,
                        md: dataTabletSpeed,
                        lg: dataDesktopSpeed
                    ...
                    var speed = breakpoints && null !== mapBreakpoints[currentBreakpoint] ? Number(mapBreakpoints[currentBreakpoint]) : dataSpeed ? dataSpeed : self.options.speed;
                    ...
                    if (searchResult) {
                        ...
                        if (delimiter) transform = " " + trimmedStyle.slice(11, delimiter).replace(/\s/g, ""); else transform = " " + trimmedStyle.slice(11).replace(/\s/g, "");
                    }
                    return {
                        baseX: bases.x,
                        baseY: bases.y,
                ...
                var updatePosition = function(percentageX, percentageY, speed, verticalSpeed, horizontalSpeed) {
                    ...
                    result.x = self.options.round ? Math.round(valueX) : Math.round(100 * valueX) / 100;
                    result.y = self.options.round ? Math.round(valueY) : Math.round(100 * valueY) / 100;
                    return result;
                };
                ...
                var animate = function() {
                    ...
                    for (var i = 0; i < self.elems.length; i++) {
                        ...
                        var verticalScrollX = -1 != verticalScrollAxis.indexOf("x") ? posY : 0;
                        var verticalScrollY = -1 != verticalScrollAxis.indexOf("y") ? posY : 0;
                        var horizontalScrollX = -1 != horizontalScrollAxis.indexOf("x") ? posX : 0;
                        var horizontalScrollY = -1 != horizontalScrollAxis.indexOf("y") ? posX : 0;
                        var percentageY = (verticalScrollY + horizontalScrollY - blocks[i].top + screenY) / (blocks[i].height + screenY);
                        var percentageX = (verticalScrollX + horizontalScrollX - blocks[i].left + screenX) / (blocks[i].width + screenX);
                        positions = updatePosition(percentageX, percentageY, blocks[i].speed, blocks[i].verticalSpeed, blocks[i].horizontalSpeed);
                        var positionY = positions.y - blocks[i].baseY;
                        var positionX = positions.x - blocks[i].baseX;
                        if (null !== blocks[i].min) {
                        ...
                        if (null != blocks[i].minY) positionY = positionY <= blocks[i].minY ? blocks[i].minY : positionY;
                        if (null != blocks[i].minX) positionX = positionX <= blocks[i].minX ? blocks[i].minX : positionX;
                        if (null !== blocks[i].max) {
                        ...
                        if (null != blocks[i].maxY) positionY = positionY >= blocks[i].maxY ? blocks[i].maxY : positionY;
                        if (null != blocks[i].maxX) positionX = positionX >= blocks[i].maxX ? blocks[i].maxX : positionX;
        ...
        da.init();
        let menuLinkCatalog = document.querySelector(".menu__link_catalog");
        let submenuCatalog = document.querySelector(".submenu-catalog");
        let submenuCatalogList = document.querySelector(".submenu-catalog__list");
        let submenuCatalogLinkCategoryActive = document.querySelector(".submenu-catalog__link-category_active");
        let script_html = document.querySelector("html");
        menuLinkCatalog.addEventListener("click", (function(e) {
            e.preventDefault();
            this.classList.toggle("_active");
            submenuCatalog.classList.toggle("_catalog-active");
        }));
        if (window.matchMedia("(max-width: 768px)").matches) {
            script_html.classList.remove("submenu-open");
            submenuCatalogList.classList.remove("_submenu-open");
            submenuCatalogLinkCategoryActive.classList.remove("_submenu-active");
        }
        ...
        function documentActions(e) {
            ...
            if (targetElement.closest("#back_1")) {
                document.documentElement.classList.remove("catalog-open");
                document.querySelector("._catalog-active") ? document.querySelector("._catalog-active").classList.remove("_catalog-active") : null;
                document.querySelector("._submenu-open") ? document.querySelector("._submenu-open").classList.remove("_submenu-open") : null;
                e.preventDefault();
            }
            if (targetElement.closest("#back_2")) {
                document.documentElement.classList.remove("submenu-open");
        ...
        const deliveryButtons = document.querySelectorAll(".product-actions__delivery");
        deliveryButtons.forEach((deliveryButton => {
            deliveryButton.onclick = () => deliveryButton.classList.toggle("_delivery-active");
        }));
        function bodyScroll() {
            let lastScroll = 0;
            const defaultOffset = 118;
            const body = document.querySelector("body");
            const scrollPosition = () => window.pageYOffset || document.documentElement.scrollTop;
            const containHide = () => body.classList.contains("_body-scroll");
            window.addEventListener("scroll", (() => {
                if (scrollPosition() > lastScroll && !containHide() && scrollPosition() > defaultOffset) body.classList.add("_body-scroll"); else if (scrollPosition() < defaultOffset) body.classList.remove("_body-scroll");
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            window.addEventListener("scroll", (function() {
                if (pageYOffset > 500) btn.classList.add("show"); else btn.classList.remove("show");
            }));
        ...
        var blockMap;
        if (document.querySelector("#block-map")) ymaps.ready(init);
        function init() {
            blockMap = new ymaps.Map("block-map", {
            ...
            blockMap.geoObjects.add(placemark);
            blockMap.behaviors.disable([ "scrollZoom" ]);
        }
        document.querySelectorAll("article table").forEach((el => {
            const wrapper = document.createElement("div");
            wrapper.className = "some-class";
            el.parentNode.insertBefore(wrapper, el);
            el.parentNode.removeChild(el);
            wrapper.appendChild(el);
        }));
        const sortingItemsPrice = document.querySelector(".sorting-items__price");
        if (document.querySelector(".sorting-items__price")) sortingItemsPrice.addEventListener("click", (function(e) {
            e.preventDefault();
            this.classList.toggle("active");
        }));
        const colorItemButtons = document.querySelectorAll(".card-sidebar__color-item");
        colorItemButtons.forEach((colorItemButton => {
            colorItemButton.addEventListener("click", (e => {
                colorItemButtons.forEach((el => {
                    el.classList.remove("active");
                }));
                colorItemButton.classList.add("active");
            }));
        }));
        const cardDeliveryButtons = document.querySelectorAll("#delivery");
        cardDeliveryButtons.forEach((cardDeliveryButton => {
            cardDeliveryButton.onclick = () => cardDeliveryButton.classList.toggle("active");
        }));
        window["FLS"] = true;
        isWebp();
        menuInit();
