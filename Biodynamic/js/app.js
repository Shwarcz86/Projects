(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-slider__slider")) new core(".main-slider__slider", {
            modules: [ Pagination, Lazy, EffectFade, Autoplay, Parallax ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            spaceBetween: 0,
        ...
        if (document.querySelector(".slider-help__slider")) new core(".slider-help__slider", {
            modules: [ Navigation, Lazy, EffectFade, Autoplay, Parallax ],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
            spaceBetween: -80,
            ...
            on: {
                init: function(swiper) {
                    ...
                    const allSlidesItems = document.querySelectorAll(".slider-help__slide:not(.swiper-slide-duplicate)");
