(() => {
    ...
    function initSliders() {
        ...
        function resizeScreen() {
            if (document.querySelector(".work__slider")) if (window.innerWidth <= 576) workSlider = new core(".work__slider", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                on: {}
            }); else if (workSlider) workSlider.destroy();
            if (document.querySelector(".main-services__slider")) if (window.innerWidth <= 576) servicesSlider = new core(".main-services__slider", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
                ...
                on: {}
            }); else if (servicesSlider) servicesSlider.destroy();
        }
